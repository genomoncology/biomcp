...
use crate::sources::clingen::GeneClinGen;
...
use self::clingen::{
    ClinGenPrefetch, add_section as add_clingen_section,
    classify_section as classify_clingen_section, fetch_section as fetch_clingen_section,
    section_outcome as clingen_section_outcome,
};
