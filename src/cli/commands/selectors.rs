//! Entity selectors for `biomcp search` and `biomcp get`.
//!
//! The top-level command routing lives in the parent module; these two enums
//! name the entity each family accepts and carry its payload arguments.
...
See also: biomcp list drug")]
    ...
    #[command(after_help = cell_line::SEARCH_AFTER_HELP)]
...
See also: biomcp list drug")]
    ...
    #[command(after_help = cell_line::GET_AFTER_HELP)]
