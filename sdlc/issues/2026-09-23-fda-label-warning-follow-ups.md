...
Ticket 1237 caps both warning paths, links truncated text to the exact DailyMed label, unifies and deduplicates warning headings, expands extraction, JSON, and Markdown coverage, updates the public docs, and removes the temporary renderer-test size exception.
