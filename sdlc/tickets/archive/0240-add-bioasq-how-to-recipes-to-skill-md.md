...
priority: 7
---
# Add BioASQ how-to recipes to SKILL.md
...
Completed under March on 2026-04-18, as March ticket 240. Imported as history when this
repo moved to the sdlc factory; it was never run by this factory.

Work products from the run — design, reviews, dev log, verify:

    /home/ian/workspace/planning/biomcp/artifacts/240-add-bioasq-how-to-recipes-to-skill-md
