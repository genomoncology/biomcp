...
priority: 9
---
# Fail installation closed when release checksum proof is unavailable
...
Work products from the run — design, reviews, dev log, verify:
    ...
    /home/ian/workspace/planning/biomcp/artifacts/620-fail-installation-closed-when-release-checksum-proof-is-unavailable
