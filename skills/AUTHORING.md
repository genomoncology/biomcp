...
A `*.ladder.json` file is the machine-readable version of the command block. It lets BioMCP attach `_meta.workflow` and `_meta.ladder[]` guidance to matching command output.
