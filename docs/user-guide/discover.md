...
biomcp discover "SHANK3 clinical trial"
...
- For trial prompts, suggests a literal disease/symptom condition search when
  present, otherwise a literal gene biomarker search.
