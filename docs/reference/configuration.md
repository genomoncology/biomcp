...
`BIOMCP_CLINGEN_BASE`, `BIOMCP_COMPLEXPORTAL_BASE`, `BIOMCP_CPIC_BASE`,
...
`BIOMCP_ORCID_BASE` is a fixture-only endpoint seam; ORCID access is anonymous
and has no credential environment variable.
