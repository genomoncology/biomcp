...
`BIOMCP_CBIOPORTAL_DATAHUB_BASE`, `BIOMCP_CELLOSAURUS_BASE`, `BIOMCP_CHEMBL_BASE`, `BIOMCP_CIVIC_BASE`, `BIOMCP_CLINVAR_BASE`,
...
`BIOMCP_EMA_REPORT_BASE`, `BIOMCP_ENRICHR_BASE`, `BIOMCP_EUROPEPMC_BASE`, `BIOMCP_FDA_ORPHAN_BASE`,
...
`BIOMCP_ORCID_BASE`,
`BIOMCP_PHARMACODB_BASE`, `BIOMCP_PHARMGKB_BASE`, `BIOMCP_PMC_HTML_BASE`, `BIOMCP_PMC_OA_BASE`,
